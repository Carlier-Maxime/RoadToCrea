package fr.metouais.roadtocrea.inventory;
...
public class CustomCraftingMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public CustomCraftingMenu(Block craftingTable, int p_39353_, Inventory p_39354_) {
        this(craftingTable, p_39353_, p_39354_, ContainerLevelAccess.NULL);
    }

    public CustomCraftingMenu(Block craftingTable, int p_39356_, Inventory p_39357_, ContainerLevelAccess p_39358_) {
    ...
    public boolean stillValid(@NotNull Player p_39368_) {
        return stillValid(this.access, p_39368_, craftingTable);
    }
