...
import fr.metouais.roadtocrea.item.MossyDirtPebbleItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> MOSSY_DIRT_PEBBLE = ITEMS.register("mossy_dirt_pebble", () -> new MossyDirtPebbleItem(new Item.Properties().tab(RoadToCrea.ROADTOCREA_TAB)));
    public static final RegistryObject<Item> FERTILIZED_MUD_PEBBLE = ITEMS.register("fertilized_mud_pebble", () -> new GrowItem(MOSSY_DIRT_PEBBLE.get().getDefaultInstance(), new Item.Properties().tab(RoadToCrea.ROADTOCREA_TAB)));
    public static final RegistryObject<Item> DIRT_PEBBLE = ITEMS.register("dirt_pebble", () -> new RainTransformableItem(MUD_PEBBLE.get().getDefaultInstance(), new Item.Properties().tab(RoadToCrea.ROADTOCREA_TAB)));
