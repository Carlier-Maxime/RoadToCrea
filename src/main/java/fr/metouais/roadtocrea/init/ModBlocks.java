...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MANGROVE_CRAFTING_TABLE = createBlock("mangrove_crafting_table", () -> new CustomCraftingTableBlock(BlockBehaviour.Properties.of(Material.WOOD)));
