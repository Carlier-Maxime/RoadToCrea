...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ULTIMATE_BEDROCK = createBlock("ultimate_bedrock", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).destroyTime(-1f).speedFactor(0.001f)));
