...
public class ModFoods {
    ...
    public static final FoodProperties COOKED_HUMAN_MEAT = (new FoodProperties.Builder()).nutrition(30).saturationMod(13.8f).effect(new MobEffectInstance(MobEffects.CONFUSION, 600, 9), 0.8f).effect(new MobEffectInstance(MobEffects.POISON, 60), 0.02f).meat().build();
}
